...
resource "oci_core_virtual_network" "mapr_vcn" {
  cidr_block = "${var.VPC-CIDR}"
  compartment_id = "${var.compartment_ocid}"
  display_name = "mapr_vcn"
  dns_label = "maprvcn"
}

resource "oci_core_internet_gateway" "mapr_internet_gateway" {
    compartment_id = "${var.compartment_ocid}"
    display_name = "mapr_internet_gateway"
...
resource "oci_core_route_table" "RouteForComplete" {
    ...
    route_rules {
        ...
        network_entity_id = "${oci_core_internet_gateway.mapr_internet_gateway.id}"
    }
}
